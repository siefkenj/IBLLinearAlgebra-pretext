...
\begin{module}\label{MODULELINESANDPLANES}
...
\begin{lesson}
	...
	\begin{itemize}
		...
		\item Explain why having a ``closed loop'' or non-trivial linear combination (giving $\vec 0$)
...
\begin{module}\label{MODULEBASIS}
...
\begin{slide}
	...
	Define the matrix $X=[\vec b_1|\vec b_2|\cdots|\vec b_n]$ to be the matrix whose columns are the $\vec b_i$ vectors
...
\begin{slide}
	...
	\begin{annotation}
		...
		\end{notes}
	\end{annotation}
	We know the following about the linear transformation $A$:
	\[
...
\begin{slide}
	...
	\begin{annotation}
		...
		\end{goals}
	\end{annotation}
	We know the following about the linear transformation $F$:
	\[
...
\begin{slide}
	...
	\begin{parts}
		...
		\item Find the characteristic polynomial of $T_A$.
			...
			\end{solution}
		\item Compute $T_A\vec w$ where $\vec w=2\vec v_1-\vec v_2$.
			\begin{solution}
...
\input{modules/appendix4.tex}
\input{modules/appendix4-exercises.tex}
\end{appendix}
