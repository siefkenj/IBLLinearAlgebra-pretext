...
describe("plugin-split-on-headings", () => {
    it("can replace latex heading macros with title tag inside section tag", () => {
        expect(convert("\\begin{module}\\Heading{Sets}\\end{module}")).toEqual(
            "<chapter label=\"module_0\"><section> <title>Sets</title> </section></chapter>"
        );
    });
    it("can wrap any plain text after a heading in p tags", () => {
        expect(
            ...
            "<chapter label=\"module_0\"><section> <title>Sets</title><p>Hello World!</p> </section></chapter>"
        );
    });
    it("handle multiple heading macros", () => {
        expect(
            ...
            "<chapter label=\"module_0\"><section> <title>Title 1</title> </section><section> <title>Title 2</title> </section><section> <title>Title 3</title> </section></chapter>"
        );
    });
    it("can wrap any plain text in between two heading in p tags inside the corresponding section tag", () => {
        expect(
            ...
            "<chapter label=\"module_0\"><section> <title>Title 1</title><p>Text 1</p> </section><section> <title>Title 2</title><p>Text 2</p> </section></chapter>"
        );
    });
    it("can replace other macros after headings", () => {
        expect(
            ...
            "<chapter label=\"module_0\"><section> <title>Sets</title><p><me>\\Set{1,2,3}.</me></p> </section></chapter>"
        );
    });
    it("Keeps exercises at the same level as <sections>", () => {
        expect(
            ...
            "<chapter label=\"module_0\"><section> <title>Sets</title><p>hi</p> </section><exercises>there</exercises></chapter>"
        );
    });
});
